  ...
  const handleEdit = async () => {
    ...
    if (currentUser.user.emailid !== email) {
      ...
      if (!email.match(emailpattern)) {
        handleReset();
        Alert.alert("Sorry", "Enter proper email id!!");
        return;
      }
    }
    if (currentUser.user.contactno !== contact) {
      ...
      if (!contact.match(contactpattern)) {
        handleReset();
        Alert.alert("Sorry", "Enter proper contact number!!");
        return;
      }
    }
        ...
        <View style={styles.userInfo}>
          <View style={styles.row}>
            <MaterialCommunityIcons
              ...
              size={35}
              color="rgba(1,0,87,0.78)"
              style={{ marginLeft: 18, marginRight: 17 }}
            />
          ...
          <View style={styles.row}>
            ...
            <View style={{ justifyContent: "center" }}>
              ...
              <TextInput
                style={[styles.rowTextInfo2]}
                value={contact}
                onChangeText={(contact) => setName(contact)}
                editable={econtact}
              />
            </View>
          </View>
