...
import { View, Text, StyleSheet, FlatList, Pressable, Image, Modal, Animated, Alert } from 'react-native'
import DateTimePicker from '@react-native-community/datetimepicker';
import imgSource from '../../assets/Images/direction.png'
import { ScrollView, TextInput } from 'react-native-gesture-handler';
import { userContext } from '../../App';
import { currentBookings } from '../../Backend/Bookings/CurrentBookings';
...
function CurrentBookingsList({ navigation, route }) {
    ...
    useLayoutEffect(() => {
        const getCurrentBookings = async () => {
            try {
                ...
                var bookings = await currentBookings(searchData)
    ...
    const handleItem = (id, item) => {
        navigation.navigate("CurrentBookingItem", { id: id, item: item })
    }
